...
- Improved scrolling smoothness across all pages in portrait mode on mobile — the app now uses hardware-accelerated scrolling, eliminating the jank that was visible when scrolling long pages vertically
